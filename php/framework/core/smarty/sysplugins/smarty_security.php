 ...
 *      - getter and setter instead of public properties would allow cultivating an internal smarty_cache properly
 *      - current implementation of isTrustedResourceDir() assumes that Smarty::$template_dir and Smarty::$config_dir are immutable
 *        the smarty_cache is killed every time either of the variables change. That means that two distinct Smarty objects with differing
