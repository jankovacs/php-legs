...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
     ...
     * @param mixed $_cache_id smarty_cache   id or null
     * @param mixed $_compile_id compile id or null
     * @param bool $_caching use caching?
     * @param int $_cache_lifetime smarty_cache life-time in seconds
     */
     ...
     * @param bool $cache flag for smarty_cache file
     * @return string
     */
     ...
     * @param integer $caching smarty_cache mode
     * @param integer $cache_lifetime life time of smarty_cache data
     ...
     *
     * - Decode saved properties from compiled template and smarty_cache files
     * - Check if compiled or smarty_cache file is valid
     *
     * @param array $properties special template properties
     * @param bool $cache flag if called from smarty_cache file
     * @return bool                 flag if compiled or smarty_cache file is valid
     */
     ...
     * @param bool $nocache smarty_cache mode of variable
    ...
    /**
     * Empty smarty_cache for this template
     *
    ...
    public function __get( $property_name )
    {
        switch ( $property_name )
        {
            case 'source':
                ...
                // smarty_cache template object under a unique ID
                // do not smarty_cache eval resources
