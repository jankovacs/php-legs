...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase
{
    ...
    /**
     * caching mode to create nocache code but no smarty_cache file
     */
    ...
    public function compile( $args, $compiler, $parameter )
    {
        ...
        * it will not be included into the common smarty_cache file and treated like
        * a nocache section
        */
        ...
        )
        {
            ...
            )
            {
                ...
                if ( !isset( $compiler->smarty->merged_templates_func[ $tpl_name ] ) || $compiler->inheritance )
                {
                    ...
                    {
                        // needs code for cached page but no smarty_cache file
