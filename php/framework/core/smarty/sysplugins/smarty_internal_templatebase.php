...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
    ...
    public function fetch( $template = null, $cache_id = null, $compile_id = null, $parent = null, $display = false, $merge_tpl_vars = true, $no_output_filter = false )
    {
        ...
        // read from smarty_cache or render
        ...
        {
            // render template (not loaded and not in smarty_cache)
            ...
            // write to smarty_cache when nessecary
            if ( !$_template->source->recompiled && ( $_template->caching == Smarty::CACHING_LIFETIME_SAVED || $_template->caching == Smarty::CACHING_LIFETIME_CURRENT ) )
            {
                ...
                foreach ( $cache_split as $curr_idx => $curr_split )
                {
                    ...
                    if ( isset( $cache_parts[ 0 ][ $curr_idx ] ) )
                    {
                        ...
                        // remove nocache tags from smarty_cache output
                ...
                // rendering (must be done before writing smarty_cache file because of {function} nocache handling)
                $_smarty_tpl = $_template;
                try
                {
                    ob_start();
                ...
                // write smarty_cache file content
    ...
    /**
     * test if smarty_cache is valid
     *
     * @param string|object $template the resource handle of the template file or template object
     * @param mixed $cache_id smarty_cache id to be used with this template
     * @param mixed $compile_id compile id to be used with this template
     * @param object $parent next higher level of Smarty variables
     * @return boolean smarty_cache status
     */
    public function isCached( $template = null, $cache_id = null, $compile_id = null, $parent = null )
    {
        ...
        // return smarty_cache status of template
    ...
    /**
     * Registers a smarty_cache resource to smarty_cache a template's output
     *
     * @param string $type name of smarty_cache resource type
    ...
    /**
     * Unregisters a smarty_cache resource
     *
     * @param string $type name of smarty_cache resource type
     * @return Smarty_Internal_Templatebase current Smarty_Internal_Templatebase (or Smarty or Smarty_Internal_Template) instance for chaining
     */
