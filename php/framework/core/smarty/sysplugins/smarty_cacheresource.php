...
{
    /**
     * smarty_cache for Smarty_CacheResource instances
     * @var array
     */
     ...
     * @param string $type name of the smarty_cache resource
    ...
    public static function load( Smarty $smarty, $type = null )
    {
        ...
        {
            // do not smarty_cache these instances as they may vary from instance to instance
        ...
        // give up
        throw new SmartyException( "Unable to load smarty_cache resource '{$type}'" );
    }
     ...
     *
     * @param Smarty_Internal_Template $_template template object
     * @param string $content content of smarty_cache
     */
...
class Smarty_Template_Cached
{
    ...
    /**
     * Id for smarty_cache locking
     * @var string
     */
    public $lock_id = null;

    /**
     * flag that smarty_cache is locked by this instance
     * @var bool
     */
    ...
    public function __construct( Smarty_Internal_Template $_template )
    {
        ...
        //
        //    check if smarty_cache is valid
        //
        ...
        while ( true )
        {
            ...
            if ( $this->valid )
            {
                ...
                {
                    // load smarty_cache file for the following checks
                    if ( $smarty->debugging )
                    {
    ...
    /**
     * Write this smarty_cache object to handler
     *
     * @param Smarty_Internal_Template $_template template object
     * @param string $content content to smarty_cache
     * @return boolean success
