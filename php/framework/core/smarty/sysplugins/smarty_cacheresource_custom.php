...
abstract class Smarty_CacheResource_Custom extends Smarty_CacheResource
{
     ...
     *
     * @param string $id unique smarty_cache content identifier
     ...
     * @param integer $mtime smarty_cache modification timestamp (epoch)
     * @return void
     */
    ...
    /**
     * Delete content from smarty_cache
     *
     * @param string $name template name
     * @param string $cache_id smarty_cache id
     * @param string $compile_id compile id
