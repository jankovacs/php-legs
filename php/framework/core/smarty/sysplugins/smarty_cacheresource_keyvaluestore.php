 ...
 * for hierarchical smarty_cache groups. key/value stores like memcache or APC do not support
 * wildcards in keys, therefore a smarty_cache group cannot be cleared like "a|*" - which
 * is no problem to filesystem and RDBMS implementations.
 *
 * This implementation is based on the concept of invalidation. While one specific smarty_cache
 * can be identified and cleared, any range of caches cannot be identified. For this reason
 * each level of the smarty_cache group hierarchy can have its own value in the store. These values
 * are nothing but microtimes, telling us when a particular smarty_cache group was cleared for the
 * last time. These keys are evaluated for every smarty_cache read to determine if the smarty_cache has
 * been invalidated since it was created and should hence be treated as inexistent.
 *
 * Although deep hierarchies are possible, they are not recommended. Try to keep your
 * smarty_cache groups as shallow as possible. Anything up 3-5 parents should be ok. So
 * »a|b|c« is a good depth where »a|b|c|d|e|f|g|h|i|j|k« isn't. Try to join correlating
 * smarty_cache groups: if your smarty_cache groups look somewhat like »a|b|$page|$items|$whatever«
...
abstract class Smarty_CacheResource_KeyValueStore extends Smarty_CacheResource
{
    ...
    /**
     * smarty_cache for contents
     * @var array
     */
    protected $contents = array();
    /**
     * smarty_cache for timestamps
     * @var array
     */
    ...
    /**
     * Fetch and prepare a smarty_cache object.
     *
     * @param string $cid CacheID to fetch
     * @param string $resource_name template name
     * @param string $cache_id smarty_cache id
    ...
    /**
     * Read values for a set of keys from smarty_cache
     *
    ...
    /**
     * Write the rendered template output to smarty_cache
     *
     * @param Smarty_Internal_Template $_template template object
     * @param string $content content to smarty_cache
     * @return boolean success
     */
    ...
    /**
     * Save values for a set of keys to smarty_cache
     *
     ...
     * @return integer number of smarty_cache files deleted [always -1]
    ...
    /**
     * Remove *all* values from smarty_cache
     *
     * @return boolean true on success, false on failure
     */
    ...
    protected function invalidate( $cid = null, $resource_name = null, $cache_id = null, $compile_id = null, $resource_uid = null )
    {
        ...
        } // invalidate all caches by smarty_cache group
        else if ( !$resource_name && $cache_id && !$compile_id )
        {
    ...
    /**
     * Empty smarty_cache for a specific template
     *
     * {@internal the $exp_time argument is ignored altogether}}
     *
     * @param Smarty $smarty Smarty object
     ...
     * @uses delete() to remove CacheID from smarty_cache
     */
     ...
     * @param string $cache_id smarty_cache id
     * @param string $compile_id compile id
     * @return string filepath of smarty_cache file
     */
    protected function getTemplateUid( Smarty $smarty, $resource_name, $cache_id, $compile_id )
    {
        ...
        if ( isset( $resource_name ) )
        {
            ...
            // remove from template smarty_cache
    ...
    /**
     * Remove values from smarty_cache
     *
    ...
    /**
     * Check is smarty_cache is locked for this template
     *
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     * @return booelan true or false if smarty_cache is locked
     */
    ...
    /**
     * Lock smarty_cache for this template
     *
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     */
    ...
    /**
     * Unlock smarty_cache for this template
     *
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     */
