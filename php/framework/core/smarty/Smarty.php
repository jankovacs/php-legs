 ...
 * File:        Smarty.php
 * SVN:         $Id: Smarty.php 4614 2012-05-24 15:13:19Z rodneyrehm $
 *
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * joined template directory string used in smarty_cache keys
     * @var string
     */
    public $joined_template_dir = null;
    /**
     * joined config directory string used in smarty_cache keys
     * @var string
     */
    ...
    /**
     * smarty_cache lifetime in seconds
     * @var integer
     */
    public $cache_lifetime = 3600;
    /**
     * force smarty_cache file creation
     * @var boolean
     */
    public $force_cache = false;
    /**
     * Set this if you want different sets of smarty_cache files for the same
     * templates.
     *
     * @var string
     */
     ...
     */
    /**
     * Controls whether smarty_cache resources should emply locking mechanism
     * @var boolean
     */
    ...
    /**
     * resource handler smarty_cache
     * @var array
     */
    public $_resource_handlers = array();
    /**
     * registered smarty_cache resources
     * @var array
     */
    public $registered_cache_resources = array();
    /**
     * smarty_cache resource handler smarty_cache
     * @var array
     */
    ...
    public function __construct()
    {
        ...
        $this->setTemplateDir( '.' . DS . 'templates' . DS )
            ...
            ->setCacheDir( '.' . DS . 'smarty_cache' . DS )
    ...
    /**
     * Empty smarty_cache folder
     *
     * @param integer $exp_time expiration time
     * @param string $type resource type
     * @return integer number of smarty_cache files deleted
     */
    function clearAllCache( $exp_time = null, $type = null )
    {
        // load smarty_cache resource and call clearAll
    ...
    {
        // load smarty_cache resource and call clear
        $_cache_resource = Smarty_CacheResource::load( $this, $type );
        Smarty_CacheResource::invalidLoadedCache( $this );
    ...
    /**
     * Get smarty_cache directory
     *
     * @return string path of smarty_cache directory
     */
     ...
     * @param mixed $cache_id smarty_cache id to be used with this template
    ...
    public function createTemplate( $template, $cache_id = null, $compile_id = null, $parent = null, $do_clone = true )
    {
        ...
        // already in template smarty_cache?
